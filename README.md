...
- ~~**Shopee/ML: todas estratégias falham (NVIDIA 410 + Gemini 429)**~~ — **RESOLVIDO (#43)**: NVIDIA fail-fast + timeout 20s/modelo, Gemini circuit 1h, hint do slug da URL, SEARCH_VERIFY antes de LLM caro. §6.28.
